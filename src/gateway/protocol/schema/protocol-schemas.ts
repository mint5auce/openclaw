...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  HaPingParams: HaPingParamsSchema,
  HaListStatesParams: HaListStatesParamsSchema,
  HaGetStateParams: HaGetStateParamsSchema,
  HaCallServiceParams: HaCallServiceParamsSchema,
  HaServiceActionParams: HaServiceActionParamsSchema,
